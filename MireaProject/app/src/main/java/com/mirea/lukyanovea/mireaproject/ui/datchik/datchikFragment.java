package com.mirea.lukyanovea.mireaproject.ui.datchik;
...
public class datchikFragment extends Fragment implements SensorEventListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        gameRotationTextView = getView().findViewById(R.id.datchik1);
        gravityTextView = getView().findViewById(R.id.datchik2);
        magneticTextView = getView().findViewById(R.id.datchik3);
    }
